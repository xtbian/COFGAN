...
class PairedLMDBDataset(BaseDataset):
    ...
    def __init__(self, data_opt, **kwargs):
        ...
        # load meta info
        gt_meta = pickle.load(
            open(osp.join(self.gt_seq_dir, '/home/bxt/FFGAN/data/REDS/GT.lmdb/meta_info.pkl'), 'rb'))
        lr_meta = pickle.load(
            open(osp.join(self.lr_seq_dir, '/home/bxt/FFGAN/data/REDS/Bicubic4xLR.lmdb/meta_info.pkl'), 'rb'))
